  ...
  return (
    <div className="mb-12 sm:mb-16 text-center">
      <div className="inline-block">
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-light mb-3 text-text-primary tracking-tight">
          My Reading Journey
        </h1>
        <div className="h-px w-24 sm:w-32 bg-accent-purple/40 mx-auto mb-8"></div>
      </div>
      
      <div className="max-w-2xl mx-auto px-4">
        <p className="text-base sm:text-lg text-text-primary/80 leading-relaxed mb-3 font-light">
